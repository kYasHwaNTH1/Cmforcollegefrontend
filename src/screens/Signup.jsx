    ...
    <div className='bg-[#191e9a] h-screen w-full flex items-center ' >
        ...
        <div className='w-1/2 shadow-lg rounded-md  h-full bg-white py-36 px-20 ' >
            ...
            <form action="" className='py-3' >
                ...
                <button className='block w-[300px] m-[1px] h-[35px] rounded-sm bg-[#191e9a] text-white hover:bg-white hover:text-black mt-4 ' >Signup</button>
                <p className='text-sm text-center mt-5 cursor-pointer ' >alreday have an account?</p>
            </form>
        </div>
    </div>
  )
